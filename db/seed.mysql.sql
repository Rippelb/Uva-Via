-- Seed compativel com MySQL/MariaDB. Conteudo identico ao seed.sql original
-- (somente INSERTs em SQL padrao, sem dependencia de Postgres).
-- Importe DEPOIS de schema.mysql.sql.
